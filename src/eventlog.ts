...
export type EventCategory = 'system' | 'probe' | 'decode' | 'encode' | 'mux' | 'output';
...
const ALL_CATS: EventCategory[] = ['system', 'probe', 'decode', 'encode', 'mux', 'output'];
